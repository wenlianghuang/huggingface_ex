...
model = "C:\\Users\\acer alan\Desktop\\Phi-3-mini-128k_test"

model = AutoModelForCausalLM.from_pretrained(
    "C:\\Users\\acer alan\Desktop\\Phi-3-mini-128k_test",
    device_map="cuda",
    torch_dtype="auto",
    trust_remote_code=True,
)
#tokenizer = AutoTokenizer.from_pretrained("microsoft/Phi-3-mini-128k-instruct")
tokenizer = AutoTokenizer.from_pretrained("C:\\Users\\acer alan\Desktop\\Phi-3-mini-128k_test")
pipe = pipeline(
    "text-generation",
    model=model,
    tokenizer=tokenizer,
